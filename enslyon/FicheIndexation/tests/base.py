...
def setup_product():
    ...
    import enslyon.FicheIndexation
    zcml.load_config('configure.zcml', enslyon.FicheIndexation)
    ...
    ztc.installPackage('enslyon.FicheIndexation')
...
setup_product()
ptc.setupPloneSite(products=['enslyon.FicheIndexation'])
